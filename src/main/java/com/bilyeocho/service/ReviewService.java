...
public class ReviewService {
    ...
    @Transactional
    public ReviewResponse createReview(ReviewRequest reviewRequest, MultipartFile reviewPhoto) {
        ...
        String reviewPhotoUrl = reviewPhoto != null ? s3Service.uploadFile(reviewPhoto) : null;
